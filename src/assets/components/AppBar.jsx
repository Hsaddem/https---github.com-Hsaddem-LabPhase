...
function ResponsiveAppBar() {
  ...
  return (
    <AppBar position="static">
      <Container sx={{backgroundColor:'LightSteelBlue'}} maxWidth="xl">
        ...
        {/* ------------------------------------------------------ */}
          ...
          >
            <img src={logo} style={{objectFit:'contain',boxSizing:'border-box',maxWidth:'30%'}}/>
          </Typography>
          {/* --------------------------------------------------------------------- */}
          ...
          <Box sx={{ flexGrow: 0 }}>
            <Tooltip title="Open settings">
              <IconButton onClick={handleOpenUserMenu} sx={{ p: 0 }}>
                <Avatar alt="Jhon Doe" src={PhotoLink?PhotoLink:""} />
              </IconButton>
            </Tooltip>
            <Menu
              sx={{ mt: '45px' }}
